...
class StaffboardController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        return view('staff.dashboard', compact('todayOrders', 'totalOrders', 'monthlyOrders', 'yearlyOrders', 'products', 'reviews', 'reports', 'totalWithdraw', 'totalPendingWithdraw', 'cardData'));
    }
